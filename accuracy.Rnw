...
cdata<-as.data.frame(cbind(rho,SENS_C,SPEC_C))
...
sdata<-as.data.frame(cbind(rho,SENS_S,SPEC_S))
...
bdata<-as.data.frame(cbind(rho,SENS_B,SPEC_B))
...
edata<-as.data.frame(cbind(rho,SENS_E,SPEC_E))
